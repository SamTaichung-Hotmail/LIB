...
BOOL WINAPI StCam_SetPriorityMode(HANDLE hCamera, DWORD dwPriorityMode);
BOOL WINAPI StCam_GetPriorityMode(HANDLE hCamera, PDWORD pdwPriorityMode);
...
BOOL WINAPI StCam_GetDevicePathA(HANDLE hCamera, PSTR pszDevicePath, PDWORD pdwBufferSize);
BOOL WINAPI StCam_GetDevicePathW(HANDLE hCamera, PWSTR pszDevicePath, PDWORD pdwBufferSize);
...
#define StCam_GetDevicePath StCam_GetDevicePathW
#else
...
#define StCam_GetDevicePath StCam_GetDevicePathA
#endif  //UNICODE
...
#define STCAM_USBPID_STC_MBS891U3V	0x0116
#define STCAM_USBPID_STC_MCS891U3V	0x0216
#define STCAM_USBPID_STC_MBS123BU3V	0x0316
#define STCAM_USBPID_STC_MCS123BU3V	0x0416
#define STCAM_USBPID_STC_MBS43U3V	0x0516
#define STCAM_USBPID_STC_MCS43U3V	0x0616
#define STCAM_USBPID_STC_MBS163U3V	0x0716
#define STCAM_USBPID_STC_MCS163U3V	0x0816
#define STCAM_USBPID_STC_MBV133U3V	0x0916
#define STCAM_USBPID_STC_MCV133U3V	0x1016
#define STCAM_USBPID_STC_MBS2041U3V	0x1116
#define STCAM_USBPID_STC_MCS2041U3V	0x1216
#define STCAM_USBPID_STC_MBS1242U3V	0x1316
#define STCAM_USBPID_STC_MCS1242U3V	0x1416
#define STCAM_USBPID_STC_MBS52HU3V	0x1516
#define STCAM_USBPID_STC_MCS52HU3V	0x1616
#define STCAM_USBPID_STC_MBS18BU3V	0x1716
#define STCAM_USBPID_STC_MCS18BU3V	0x1816
#define STCAM_USBPID_STC_MBS212U3V	0x1916
#define STCAM_USBPID_STC_MCS212U3V	0x2016
#define STCAM_USBPID_STC_MBS280U3V	0x2116
#define STCAM_USBPID_STC_MCS280U3V	0x2216
#define STCAM_USBPID_STC_MBS71BU3V	0x2316
#define STCAM_USBPID_STC_MCS71BU3V	0x2416
//-----------------------------------------------------------------------------
//AVI_STATUS
//-----------------------------------------------------------------------------
...
//PRIORITY_MODE
//-----------------------------------------------------------------------------
#define STCAM_PRIORITY_MODE_IMAGE_QUALITY	0
#define STCAM_PRIORITY_MODE_FRAME_RATE	1
#ifdef __cplusplus
};
#endif  //__cplusplus
#endif //STCAMD_H
